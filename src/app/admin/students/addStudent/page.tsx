            ...
            {currentStep === 1 && (
              <div className="space-y-6 animate-fadeIn">
                <div>
                  ...
                  <p className="text-gray-600">Please provide the student's basic personal details</p>
                </div>
            ...
            {currentStep === 2 && (
              <div className="space-y-6 animate-fadeIn">
                <div>
                  ...
                  <p className="text-gray-600">Tell us about the student's educational background and interests</p>
                </div>
